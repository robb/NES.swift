...
internal extension CPU {
    ...
    func step() {
        ...
        case 0x13: perform(indirectIndexed, SLO, incursPageBoundaryCost: true)
        ...
        case 0x33: perform(indirectIndexed, RLA, incursPageBoundaryCost: true)
        ...
        case 0x53: perform(indirectIndexed, SRE, incursPageBoundaryCost: true)
        ...
        case 0x73: perform(indirectIndexed, RRA, incursPageBoundaryCost: true)
        ...
        case 0xD3: perform(indirectIndexed, DCP, incursPageBoundaryCost: true)
        ...
        case 0xF3: perform(indirectIndexed, ISC, incursPageBoundaryCost: true)
    ...
    func cyclesSpent(opcode: UInt8) -> UInt64 {
        switch opcode {
